...
;
[Setup]
AppID={{a212a9b7-3da3-4199-aff7-f2318848f2eb}
AppName=ASCOM USB_Focus_Tester Rotator Driver
AppVerName=ASCOM USB_Focus_Tester Rotator Driver 1.0.1
AppVersion=1.0.1
...
OutputDir="."
OutputBaseFilename="USB_Focus_Tester Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Rotator\USB_Focus_Tester"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Rotator\USB_Focus_Tester"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\manoj\OneDrive\Documents\Visual Studio 2015\Projects\USB_Focus Rotator\USB_Focuser Rotator Tester\bin\Release\ASCOM.USB_Focus.Test.exe"; DestDir: "{app}"
; TODO: Add driver assemblies into the ServedClasses folder
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\manoj\OneDrive\Documents\Visual Studio 2015\Projects\USB_Focus Rotator\USB_Focuser Rotator Tester\ReadMe.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{app}\ASCOM.USB_Focus.Test.exe"; Parameters: "/register"
...
; Only for .NET local-server drivers
Filename: "{app}\ASCOM.USB_Focus.Test.exe"; Parameters: "/unregister"
